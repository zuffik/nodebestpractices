...
###### Vytvoril a udržiava [Riadiaci výbor](#steering-committee) a [Ostatní spolupracovníci](#collaborators)
...
- **:whale: Osvedčené postupy pre Node.js + Docker**: nedávno sme vydali sekciu týkajúcu sa Docker-u a Node.js, ktorá obsahuje 15 bodov ohľadom použitia Docker-u

- **🎤 Rozhovor na OdessaJS**: Budeme rozprávať o testovaní Node.js tento týždeň na [konferencii OdessaJS](https://odessajs.org/)
